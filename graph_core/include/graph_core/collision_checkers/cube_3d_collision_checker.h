...
public:
   ...
   */
  virtual bool pluginInit(const std::string& param_ns,const cnr_logger::TraceLoggerPtr& logger, const double& min_distance = 0.01) override
  {
    return init(logger,min_distance);
  }
